...
- API/CLI contract suites and migration consistency checks pass locally. CI now runs both API and worker PostgreSQL integration suites explicitly; exact-commit verification is pending.

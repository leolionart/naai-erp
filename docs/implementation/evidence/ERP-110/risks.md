...
- Local PostgreSQL integration could not run because Docker Desktop and a native PostgreSQL client/server were unavailable. Exact-commit GitHub CI supplied PostgreSQL 16 and passed the migration plus integration suite.

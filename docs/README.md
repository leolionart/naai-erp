...
- `agent/overnight-runbook.md`: autonomous execution and resumability protocol.
- `implementation/task-ledger.yaml`: machine-readable task/dependency/status source.

Future code documentation belongs here:

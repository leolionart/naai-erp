...
export const MASTER_DATA_RESOURCES = {
  ...
  categories: {
    ...
    organizationColumn: "organization_id",
    keyColumns: ["kind", "code"],
    writableColumns: ["kind", "code", "name", "account_code", "tax_code", "is_active"],
    mutableColumns: ["name", "account_code", "tax_code", "is_active"],
    deactivate: { column: "is_active", value: false },
    versionColumn: "version",
  },
  "business-categories": {
  ...
  "workforce-profiles": {
    ...
    mutableColumns: ["ends_on", "active", "updated_by"],
    deactivate: { column: "active", value: false },
    versionColumn: "version",
  },
  "party-roles": {
    table: "party_roles",

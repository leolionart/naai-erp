  ...
  beforeAll(async () => {
    await pool.query(`
      ...
      insert into journal_entries(organization_id,id,journal_date,description,currency,state,version,created_by,posted_at,posted_by) values
        ...
        ('org-erp430','j-credit','2026-08-02','AR credit','VND','posted',2,'finance',now(),'finance'),
        ('org-erp430','j-pay','2026-08-10','Receipt','VND','reversed',3,'finance',now(),'finance'),
        ('org-erp430','j-pay-rev','2026-08-20','Receipt reversal','VND','posted',2,'finance',now(),'finance'),
        ('org-erp430','j-ap','2026-08-03','AP invoice','VND','posted',2,'finance',now(),'finance');

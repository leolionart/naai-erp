      ...
      isForecastComponent && action === "delete"
        ...
        : action === "list" ||
          ...
          : action === "update"
            ? "PATCH"
            : "POST";
    const path = isPerformanceComparison
      ? base
